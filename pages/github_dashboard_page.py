...
from pages.create_new_repository_page import CreateNewRepositoryPage
from pages.import_repository_page import ImportRepositoryPage
...
class GitHubDashboardPage(BasePage):
    ...
    def click_create_repository(self):
        self.wait_for_visible_element(self.CREATE_REPOSITORY_BUTTON, 10).click()
        return CreateNewRepositoryPage(self.driver)

    def get_read_guide_button(self):
        return self.wait_for_visible_element(self.READ_GUIDE_BUTTON, 10)
    ...
    def click_import_repository(self):
        self.wait_for_visible_element(self.IMPORT_REPOSITORY_BUTTON, 10).click()
